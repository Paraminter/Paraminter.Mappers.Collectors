    ...
    where TArgumentData : IArgumentData
{
    ...
    public abstract Mock<IArgumentAssociatorMappingsCollector<TParameter, ICommandHandler<IAssociateSingleMappedArgumentCommand<TArgumentData>>>> MappingsCollectorMock { get; }
}
