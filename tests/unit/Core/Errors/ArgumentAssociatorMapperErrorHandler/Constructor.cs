...
public sealed class Constructor
{
    ...
    private static ArgumentAssociatorMapperErrorHandler<TParameter> Target<TParameter>(
        ICommandHandler<IHandleUnmappedParameterCommand<TParameter>> unmappedParameter)
        where TParameter : IParameter
    {
        return new ArgumentAssociatorMapperErrorHandler<TParameter>(unmappedParameter);
    }
}
