...
public sealed class Constructor
{
    ...
    private static ArgumentAssociatorMappingsCollectorErrorHandler<TParameter> Target<TParameter>(
        ICommandHandler<IHandleDuplicateParameterCommand<TParameter>> duplicateParameter)
        where TParameter : IParameter
    {
        return new ArgumentAssociatorMappingsCollectorErrorHandler<TParameter>(duplicateParameter);
    }
}
