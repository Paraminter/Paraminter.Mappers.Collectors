...
public sealed class Handle
{
    ...
    public void ValidArguments_NullAction()
    {
        ...
        var result = Record.Exception(() => Target(fixture, Mock.Of<IAssociateIndividualMappedArgumentCommand<IArgumentData>>()));
    ...
    private static void Target<TArgumentData>(
        ...
        IAssociateIndividualMappedArgumentCommand<TArgumentData> command)
