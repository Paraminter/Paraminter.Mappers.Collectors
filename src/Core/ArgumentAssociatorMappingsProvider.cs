...
/// <summary>Provides the mappings from parameters to associators of arguments and that parameter.</summary>
    ...
    where TArgumentData : IArgumentData
{
    ...
    /// <summary>Instantiates a provider of the mappings from parameters to associators of arguments and that parameter.</summary>
    /// <param name="mappings">The mappings from parameters to associators of arguments and that parameter.</param>
